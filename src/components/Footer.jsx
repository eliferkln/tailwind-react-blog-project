...
const Footer = () => {
  ...
  return (
    <div className='max-w-[1440px] mx-auto py-24 px-4 grid lg:grid-cols-2 gap-8 text-gray-300 justify-between border-t-2 border-[#dadada63]'>
      ...
      <div className='flex flex-col sm:flex-row items-center gap-4 '>
            <input
              ...
              placeholder='Email'
            />
            <button className='bg-[#13426ca6] hover:bg-[#dadada63] hover:text-[#13426ca6]  text-white rounded-md font-medium w-[200px]  my-6 px-6 py-3 '>
           Contact Me!
            </button>
          </div>
          <p >
